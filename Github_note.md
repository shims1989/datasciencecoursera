##Github beginner's not --github repo
...
*git remote add origin @Ìîinput your remote repo address, end with .git@ (this step can be droped if the repo already loaded)
